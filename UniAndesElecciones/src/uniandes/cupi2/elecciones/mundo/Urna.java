...
public class Urna
{
     ...
     */
  //TODO Declare el atributo de candidato3
    ...
    {
    	//TODO Complete el m�todo seg�n la documentaci�n.
        double numVotosCandidato;
        double votosInternetCandidato;

        double porcentaje;

        numVotosCandidato = candidato1.darVotos();
        votosInternetCandidato = candidato1.darVotosInfluenciaInternet();

        porcentaje = numVotosCandidato / votosInternetCandidato * 100;
    ...
    public double calcularPorcentajeVotosPorInternetCandidato2( )
    {
        ...
        numVotosCandidato = candidato2.darVotos();
        votosInternetCandidato = candidato2.darVotosInfluenciaInternet();
    ...
    public double calcularPorcentajeVotosPorInternetCandidato3( )
    {
        ...
        numVotosCandidato = candidato3.darVotos();
        votosInternetCandidato = candidato3.darVotosInfluenciaInternet();
